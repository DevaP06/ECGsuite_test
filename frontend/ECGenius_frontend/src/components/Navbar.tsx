    ...
    <nav className="bg-black shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              to="/register"
              className="ml-4 bg-gradient-to-r from-blue-500 via-blue-400 to-cyan-400 text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity font-semibold whitespace-nowrap"
            >
              Get Started
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 pt-2 space-y-2 bg-black border-t border-gray-800">
          ...
          <Link
            to="/register"
            className="block w-full text-center bg-gradient-to-r from-blue-500 via-blue-400 to-cyan-400 text-white px-4 py-2 rounded-lg mt-2 hover:opacity-90 transition-opacity font-semibold"
            onClick={() => setIsOpen(false)}
          >
            Get Started
          </Link>
